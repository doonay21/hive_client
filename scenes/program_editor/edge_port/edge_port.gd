...
const TEX_NONE = preload("res://assets/images/program_editor/edge_port_none.png")
const TEX_IN = preload("res://assets/images/program_editor/edge_port_in.png")
const TEX_OUT = preload("res://assets/images/program_editor/edge_port_out.png")
...
func on_mouse_entered() -> void:
	...
	match port_type:
		BlockData.Port.NONE: port_name = tr("program_editor.edge_port.none")
		BlockData.Port.INPUT: port_name = tr("program_editor.edge_port.input")
		BlockData.Port.OUTPUT: port_name = tr("program_editor.edge_port.output")
		
	Events.info_text_requested.emit(tr("program_editor.edge_port.info").format({ "port_name": port_name }))
