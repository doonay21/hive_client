...
func on_mouse_entered() -> void:
	...
	Events.info_text_requested.emit(tr("program_editor.test.info"))
...
func open_simulator() -> void:
	...
	program_simulator_instance.program_editor = program_editor
	program_editor.add_child(program_simulator_instance)
