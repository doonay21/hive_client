...
enum Op { NONE, SIGHT, MOVED, GEO, COMPASS, CLOCK, INVERTER, COMPARATOR, MINIMUM, MAXIMUM, ADD, SUB, DIV, MUL, MODULO, AVG, ABS, DELAY, LATCH, COUNTER, SWITCH, EDGE, THRESHOLD, EMITTER, RECEIVER, BROADCAST, SCANNER, DISH, TURN_LEFT, GO, TURN_RIGHT, TURN_AROUND, DIG, CONSTANT, SINUS, NOISE, RANDOM, CONNECTION_WE, CONNECTION_ES, CONNECTION_WS, CONNECTION_WES, CONNECTION_EWS, CONNECTION_CROSS, CONNECTION_CROSS_JOINED, CUSTOM }
