...
func initialize_grid() -> void:
	...
	var total_dim: int = internal_dim + 2
...
func on_context_menu_id_pressed(id: int) -> void:
	match id:
		0:
			current_selected_node.port_type = EdgePort.Port.NONE
		1:
			current_selected_node.port_type = EdgePort.Port.INPUT
		2:
			current_selected_node.port_type = EdgePort.Port.OUTPUT
